...
//bg colors
#define SAND COLOR(30, 28, 22) //@ row 77
#define OCEAN COLOR(8, 9, 26) //@ row 41
#define SKY COLOR(19, 27, 29) //@ row 0
//screen dimensions
...
void drawRectBack(int , int , int , int, unsigned short top, unsigned short mid, unsigned short bot);
